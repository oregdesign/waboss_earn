// components/dashboard/MobileLayout.jsx
import React from 'react';
import { AnimatePresence, motion } from 'framer-motion';
import { Eye, EyeOff, CheckCircle, XCircle } from 'lucide-react';
import CarouselMobile from '../CarouselMobile'; // Adjust path as needed
import WhatsappListMobile from '../WhatsappListMobile'; // Adjust path as needed
            ...
            <div className="bg-[#1f275a] p-6 rounded-2xl shadow-xl w-11/12 max-w-sm text-gray-200 font-futuristic">
              ...
              {withdrawSuccess === 'success' ? (
                ...
                <form onSubmit={handleWithdrawSubmit} className="space-y-5 text-left">
                  ...
                  {/* Jumlah Penarikan */}
                  <div>
                    <label className="block text-gray-300/2 text-sm mb-1">
                      Jumlah Penarikan
                    </label>
                    <input
                      type="text"
        ...
        {isBonusModalOpen && (
          ...
          >
            <div className="bg-[#1f275a] p-6 rounded-2xl shadow-2xl text-center relative overflow-hidden">
              ...
              <p className="text-gray-300 mt-2">Kamu mendapat <span className="text-yellow-400 font-bold">Rp10.000</span></p>
              <button
        ...
        {showBonus && (
          ...
          >
            ...
            >
              ...
              <span className="font-bold">Klaim Bonus Pertama!</span>
            </button>
          </motion.div>
        )}
